...
if (!fs.existsSync(indexPath)) {
  ...
  if (!html.includes('function loseLife') || !html.includes('function respawnHero') || !html.includes('levelIntroTimer')) {
    fail('gameplay must include death/respawn handling and level intro narrative.');
  }
  if (!html.includes('Dependency Cavern') || !html.includes('Rogue Architect')) {
    fail('gameplay must preserve the multi-level narrative arc.');
  }
}
