...
help:
	...
	@echo ""
	@echo "Set WATSONX_API_KEY and WATSONX_PROJECT_ID before make build/generate."
	@echo "Use make verify when you only want to validate the checked-in static game."
