...
This is **Batch 07**. It builds on commit mc-97e2f86b640e. Implement only what this batch requires — nothing else.
...
## Task TASK-002: Repair: fix non-finite gradient crash
