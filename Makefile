...
help:
	...
	@echo "  make build                  Run strict from-zero governed generation (no fallback)"
	...
	@echo "make build is strict and fails if governed tools or watsonx credentials are unavailable."
	@echo "Use make verify to validate checked-in artifacts without governed generation."
...
build:
	...
	@REQUIRE_GOVERNED_TOOLS=1 ./build.sh from-zero
