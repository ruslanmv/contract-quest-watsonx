...
## Gameplay narrative pass

The game now plays more like a readable arcade platformer instead of a loose canvas demo:

- **Level 1 — Build Fields:** tutorial pacing with safe ground, a first Bug Bot stomp, coin arcs, a shield pickup, checkpoint, and Matrix Gate.
- **Level 2 — Dependency Cavern:** platform gaps, moving platforms, Double Jump, validation keys, and Prompt Slimes teach traversal risk.
- **Level 3 — Validation Gate:** a boss arena with Shield, Rogue Architect rules, three vulnerable stomps, and a locked final gate.
- **Death and retry:** pits and enemy hits now cost a life, reload the hero at the checkpoint/start, and show clear feedback instead of silently clamping the player back onto the bottom of the screen.
- **Narrative UX:** start, level-intro, level-complete, game-over, and win messaging explain the contract story, objective, and controls.
